...
export default function AdminDashboard() {
  ...
  // ✅ Fetch tasks and users from backend (Render/Vercel)
  useEffect(() => {
  ...
  const downloadTaskReport = async (format) => {
    ...
    if (format === "pdf") {
      try {
        ...
        alert("Failed to generate Task PDF. Check console for details.");
      }
    } else {
      // Excel
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-white to-pink-100 pt-24">
      ...
      <div className="flex items-center justify-center">
        <div className="bg-white p-10 rounded-3xl shadow-2xl text-center w-full max-w-2xl border border-gray-200">
          {loading ? (
            <p className="text-gray-600 animate-pulse">⏳ Loading Admin Data...</p>
          ) : (
            <>
              ...
              <div className="mt-10 space-y-3">
                <p className="text-lg font-semibold text-gray-700 mb-2">📊 Download Reports</p>
